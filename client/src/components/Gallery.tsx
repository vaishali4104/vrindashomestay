        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {images.map((image, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="cursor-pointer rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all"
        ...
        <DialogContent className="sm:max-w-4xl p-0 bg-transparent border-none">
          <div className="relative">
            <button 
              ...
              className="absolute top-4 right-4 bg-black/50 rounded-full p-1 text-white z-10 hover:bg-black/70 transition-colors"
            >
              <X className="h-6 w-6" />
            </button>
