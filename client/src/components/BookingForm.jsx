...
export default function BookingForm() {
    ...
    return (<section id="booking" className="py-20 bg-accent/10">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <FormField control={form.control} name="guests" render={({ field }) => (<FormItem>
                  ...
                  <FormField control={form.control} name="checkIn" render={({ field }) => (<FormItem className="flex flex-col">
                  ...
                  <FormField control={form.control} name="checkOut" render={({ field }) => (<FormItem className="flex flex-col">
                ...
                (checkInDate ? date <= checkInDate : false))} initialFocus/>
                          </PopoverContent>
                        </Popover>
                        <FormMessage />
                      </FormItem>)}/>
                ...
                {isAvailable !== null && (<div className={`p-4 rounded-md ${isAvailable ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}>
